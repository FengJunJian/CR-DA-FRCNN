...
class CombinedROIHeads(torch.nn.ModuleDict):
    ...
    def forward(self, features, proposals, targets=None):
        losses = {}
        # rename x to roi_box_features, if it doesn't increase memory consumption
    ...
    #     '''
    #     losses = {}
    #     proposalsFeatures=None
    #
    #     x, detections, loss_box, da_ins_feas, da_ins_labels = self.box(features, proposals, targets)
    #     losses.update(loss_box)
    #     return x, detections, losses, da_ins_feas, da_ins_labels,proposalsFeatures
...
def build_roi_heads(cfg):
    ...
    if roi_heads:
        roi_heads = CombinedROIHeads(cfg, roi_heads)#registry box,mask,keypoint if they are ON
