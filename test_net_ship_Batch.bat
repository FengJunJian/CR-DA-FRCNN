...
python tools/test_net.py --config-file configs/da_ship/sw_da_faster_rcnn_R_50_C4_SS2SMD_ship.yaml --flagVisual True --checkpoint model_0020000.pth OUTPUT_DIR ../SW_LCGC/logSSToSMDship DATASETS.TEST ('ship_test_SMD_cocostyle','ship_test_SeaShips_cocostyle') MODEL.SW.LC True MODEL.SW.GC True

python tools/test_net.py --config-file configs/da_ship/sw_da_faster_rcnn_R_50_C4_SS2SMD_ship.yaml --flagVisual True --checkpoint model_0020000.pth OUTPUT_DIR ../SW_LCGC/logSMDToSSship DATASETS.TEST ('ship_test_SeaShips_cocostyle','ship_test_SMD_cocostyle') MODEL.SW.LC True MODEL.SW.GC True
...
python tools/test_net.py --config-file configs/da_ship/sw_da_faster_rcnn_R_50_C4_SS2SMD_ship.yaml --checkpoint model_0005000.pth OUTPUT_DIR ../SWPA1/logSSToSMDship DATASETS.TEST ('ship_test_SeaShips_cocostyle','ship_test_SMD_cocostyle')

rem DA
rem python tools/test_net.py --config-file configs/da_ship/sw_da_faster_rcnn_R_50_C4_SS2SMD_ship.yaml --flagVisual True --checkpoint model_0020000.pth OUTPUT_DIR ../SWA3/logSSToSMDship DATASETS.TEST ('ship_test_SMD_cocostyle',)
