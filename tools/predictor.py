...
class COCODemo(object):
    ...
    def __init__(
        ...
        checkpointer = DetectronCheckpointer(cfg, self.model, save_dir=model_dir)
    ...
    def build_transform(self):
        ...
        transform = T.Compose(
            [
                T.ToPILImage(),
                T.Resize((min_size, max_size)),#(H,W)#self.min_image_size
                T.ToTensor(),
                to_bgr_transform,
                normalize_transform,
            ]
    ...
    def compute_colors_for_labels(self, labels):
        ...
        # return colors
        import colorsys
        num_color = len(self.CATEGORIES)#self.cfg.MODEL.ROI_BOX_HEAD.NUM_CLASSES
